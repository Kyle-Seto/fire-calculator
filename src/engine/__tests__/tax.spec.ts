...
import { BASIC_PERSONAL_AMOUNT, FEDERAL_BRACKETS } from "@/data/taxBrackets";
import {
...
describe("calculateIncomeTax", () => {
	it("returns $0 for $0 income", () => {
		expect(calculateIncomeTax(0, FEDERAL_BRACKETS, BASIC_PERSONAL_AMOUNT)).toBe(0);
	});

	it("returns $0 for negative income", () => {
		expect(calculateIncomeTax(-10_000, FEDERAL_BRACKETS, BASIC_PERSONAL_AMOUNT)).toBe(0);
	});
